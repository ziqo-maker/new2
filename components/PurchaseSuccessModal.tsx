...
<div className="fixed max-w-xl mx-auto inset-0 bg-[#808080] overflow-x-auto bg-opacity-50 h-screen   items-center z-40 justify-center p-2 ">
    <center>
    <div className="bg-white max-w-xl mx-auto h-screen  border-4 border-double border-[#ffae19]/[0.9] glowbox transform  rounded-3xl bg-white shadow-xl  data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in  data-closed:sm:translate-y-0 data-closed:sm:scale-95">
