                    ...
                    return(
                      <center key={index}>
                        <div className="h-3"/>
                         ...
                         <div className="grow flex items-center">
                         <Image
    src={task.id == "49" ? bees as StaticImageData : task.id == "52" ?  trx as StaticImageData : task.id == "54" ? dystopia as StaticImageData : task.id == "31" ? kombat as StaticImageData : task.id == "3" ? boinkers as StaticImageData : task.id == "25" ? robus as StaticImageData : task.id == "17" ? industry as StaticImageData : task.id == "60" ? unk as StaticImageData : task.id == "20" ? net as StaticImageData : task.icon}
  className="w-11 h-11  aspect-square object-cover  "
  alt="Shiba Inu"
/>
