...
new Toast({
  ...
  new Toast({
    ...
    <hr className="flex grow  my-8 bg-white border-2 border-dashed border-[#ffae19]/[0.9] dark:bg-white"/>
          ...
          <center >
        <button onClick={() => {valuestar == 0 ? '' : handlePurchase}} className={`${valuestar == 0? 'opacity-60' :''}  flex flex-grow  px-8 bg-[#ffae19]/[0.9] border-white border-4  border-double items-center justify-center text-center text-wrap  rounded-2xl  px-2 py-[8px]`}>
